...
<body>
    ...
    <nav class="navbar navbar-light bg-redeph noprint">
    ...
    <div class="wrapper">
        ...
        <div id="content-container">
            ...
            <div class="form-group noprint" style="padding: 20px 20px 170px 20px;">
                <center>
                    <?php    
            ...
            <!-- Footer -->
            <footer class="text-center noprint" style="background-color: #f39822">
                <!-- Grid container -->
